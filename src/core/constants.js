...
export const COLLECTION_SORT_DATE_ADDED: 'COLLECTION_SORT_DATE_ADDED' = 'added';
export const COLLECTION_SORT_DATE_ADDED_DESCENDING: 'COLLECTION_SORT_DATE_ADDED_DESCENDING' =
  '-added';
export const COLLECTION_SORT_NAME: 'COLLECTION_SORT_NAME' = 'name';
export const COLLECTION_SORT_POPULARITY: 'COLLECTION_SORT_POPULARITY' =
  'popularity';
