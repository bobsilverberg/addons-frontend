...
export const withExperiment = ({
  ...
  class WithExperiment extends React.Component<withExperimentInternalProps> {
    ...
    constructor(props: withExperimentInternalProps) {
      ...
      const registeredExperiments = cookies.get(EXPERIMENT_COOKIE_NAME);
      console.log('---- registeredExperiments: ', registeredExperiments);
      ...
      for (const experimentId of Object.keys(registeredExperiments)) {
        ...
        console.log(
          '---- _isExperimentEnabled({ _config, id: experimentId }): ',
          _isExperimentEnabled({ _config, id: experimentId }),
        );
        ...
        console.log('---- cleanedExperiments: ', cleanedExperiments);
      }

      if (registeredExperiments !== cleanedExperiments) {
        console.log('---- cleanedExperiments: ', cleanedExperiments);
